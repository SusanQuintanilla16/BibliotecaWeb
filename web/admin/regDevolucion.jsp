<%-- 
    Document   : regDevolucion
    Created on : 14-may-2018, 11:20:12
    Author     : Susan
--%>
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="container-fluid">
          <form method="post" action="http://localhost:8083/BibliotecaWeb/VerDevolucion" onsubmit="return validacion()">
              <div class="form-group">
